          ...
          <div key={_index} className="w-full  md:flex ">
            <div className=" flex-col container md:w-full md:flex ">
              <div className="flex justify-center">
                <span className="md:text-5xl text-xl mt-6 md:mt-0 font-bold text-green-800">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex w-full justify-center h-full">
                              <span
                                className="flex  h-12  font-semibold text-white text-lg"
                                style={{
                                  position: "absolute",
                                  bottom: 20,
                                  left: 10,
                            ...
                            <div className="">
                              {selectedIndex === index && (
                                ...
                                <>
                                  <div
                                    className="absolute z-10 bg-green-100 top-0 bottom-0 left-0 right-0 hover:scale-110  transition-all "
                                    style={{
                                      boxShadow:
